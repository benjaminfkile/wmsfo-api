...
- `docs/contracts.md`: every name, shape, path, and rule the components code against. Wins over any other document on a conflict.
...
The site, admin panel, beacon app, simulator beacon, and legacy beacon repositories carry copies of `DESIGN.md` and `contracts.md`; the originals are here.
...
contracts/                        generated and hand-written contract artifacts (contracts.md section 13)
icons/                            the icon library
templates/email/                  SES templates
```
