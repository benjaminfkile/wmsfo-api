...
namespace Wmsfo.Api.Data.Migrations
{
    ...
    [Migration("20260920120000_A45EventLatestFix")]
    partial class A45EventLatestFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wmsfo.Api.Data.AuditLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Wmsfo.Api.Data.Beacon", b =>
                {
                    ...
                    b.Property<long>("FixesCarried")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(0L)
                        .HasColumnName("fixes_carried")
            ...
            modelBuilder.Entity("Wmsfo.Api.Data.Event", b =>
                {
                    ...
                    b.Property<JsonDocument>("LatestFix")
                        .HasColumnType("jsonb")
                        .HasColumnName("latest_fix")
            ...
            modelBuilder.Entity("Wmsfo.Api.Data.Location", b =>
                {
                    ...
                    b.Property<string>("SpeedSource")
                        .HasColumnType("text")
                        .HasColumnName("speed_source")
                    ...
                    b.HasIndex("EventId", "BeaconId", "Seq")
                        .IsDescending(false, false, true)
                        .HasDatabaseName("location_event_beacon_seq");

                    b.HasIndex("EventId", "Lat", "Lng")
                        .IsUnique()
            ...
            modelBuilder.Entity("Wmsfo.Api.Data.MediaAsset", b =>
                {
                    ...
                    b.Property<string>("DziKey")
                        .HasColumnType("text")
                        .HasColumnName("dzi_key")
            ...
            modelBuilder.Entity("Wmsfo.Api.Data.Place", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long?>("OpensPageId")
                        .HasColumnType("bigint")
                        .HasColumnName("opens_page_id");

                    b.Property<long?>("ParentId")
                        .HasColumnType("bigint")
                        .HasColumnName("parent_id");

                    b.Property<string>("PinSource")
                        .HasColumnType("text")
                        .HasColumnName("pin_source");
            ...
            modelBuilder.Entity("Wmsfo.Api.Data.QrAttachment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("PlaceId", "FromAt")
                        .IsDescending(false, true)
                        .HasDatabaseName("qr_attachment_place");

                    b.ToTable("qr_attachment", null, t =>
                        {
            ...
            modelBuilder.Entity("Wmsfo.Api.Data.QrCode", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("qr_code_pkey");

                    b.HasAlternateKey("Tag")
                        .HasName("qr_code_tag_key");

                    b.ToTable("qr_code", null, t =>
                        {
            ...
            modelBuilder.Entity("Wmsfo.Api.Data.QrScan", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("qr_scan_pkey");

                    b.HasIndex("AttachmentId", "At")
                        .IsDescending(false, true)
                    ...
                    b.HasIndex("QrCodeId", "At")
                        .IsDescending(false, true)
                        .HasDatabaseName("qr_scan_code_at");

                    b.ToTable("qr_scan", null, t =>
                        {
            ...
            modelBuilder.Entity("Wmsfo.Api.Data.EventStatusHistory", b =>
                {
                    ...
                    b.HasOne("Wmsfo.Api.Data.Outbox", null)
                        ...
                        .HasForeignKey("OutboxId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("event_status_history_outbox_id_fkey");
            ...
            modelBuilder.Entity("Wmsfo.Api.Data.Place", b =>
                {
                    b.HasOne("Wmsfo.Api.Data.Page", null)
                        .WithMany()
                        .HasForeignKey("OpensPageId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("place_opens_page_id_fkey");

                    b.HasOne("Wmsfo.Api.Data.Place", null)
                        .WithMany()
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("place_parent_id_fkey");
                });
            ...
            modelBuilder.Entity("Wmsfo.Api.Data.QrAttachment", b =>
                {
                    b.HasOne("Wmsfo.Api.Data.Place", null)
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("qr_attachment_place_id_fkey");

                    b.HasOne("Wmsfo.Api.Data.QrCode", null)
                        .WithMany()
                        .HasForeignKey("QrCodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("qr_attachment_qr_code_id_fkey");
                });
            ...
            modelBuilder.Entity("Wmsfo.Api.Data.QrCode", b =>
                {
                    b.HasOne("Wmsfo.Api.Data.Page", null)
                        ...
                        .HasForeignKey("OpensPageId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("qr_code_opens_page_id_fkey");
                });

            modelBuilder.Entity("Wmsfo.Api.Data.QrScan", b =>
                {
                    b.HasOne("Wmsfo.Api.Data.QrAttachment", null)
                        .WithMany()
                        .HasForeignKey("AttachmentId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("qr_scan_attachment_id_fkey");

                    b.HasOne("Wmsfo.Api.Data.Event", null)
                        .WithMany()
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("qr_scan_event_id_fkey");
                    ...
                    b.HasOne("Wmsfo.Api.Data.QrCode", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("qr_scan_qr_code_id_fkey");
                });
