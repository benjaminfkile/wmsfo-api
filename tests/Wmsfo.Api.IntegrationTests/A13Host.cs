...
public sealed class A13Host : IAsyncDisposable
{
    ...
    private static readonly KindRegistry _sharedRegistry = KindRegistry.Load(TestPaths.ContractsDir);
    private static readonly SchemaValidator _sharedValidator = new(_sharedRegistry);
